...
import BonusBlockBonusblockBonusblock from './bonus-block/bonusblock.bonusblock'
...
export default { 
  BonusBlockBonusblockBonusblock: load(BonusBlockBonusblockBonusblock, 'bonusblock.bonusblock'),
