...
import {BBlockLogo, GithubIcon, Link, MenuIcon, MobileMenuModal} from '../../components/Ui';
            ...
            <div className="container">
                ...
                <span className="text-gray dark:text-gray-600">Docs</span>
                    ...
                    <div className="flex-1 flex-shrink-0 flex justify-end items-center space-x-2 md:space-x-6">
                        <Link className="hidden md:inline-block" href="https://github.com/BBlockLabs" externalIcon={false}>
